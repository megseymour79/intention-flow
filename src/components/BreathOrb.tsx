    ...
    >
      ...
      {running ? (
        ...
        <button
          type="button"
          onClick={begin}
          className="rounded-full border border-amber-300/40 bg-amber-300/10 px-5 py-2 text-sm font-bold text-amber-100 transition-all hover:scale-105 hover:bg-amber-300/20"
        >
