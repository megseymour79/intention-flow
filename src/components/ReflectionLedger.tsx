  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        {seeded && (
          <span className="rounded-full border border-emerald-300/30 bg-emerald-300/10 px-2.5 py-1 text-[11px] font-semibold text-emerald-200">
            logged tonight ✓
          </span>
        )}
      </div>
      ...
      <div className="mt-4 flex flex-wrap items-center gap-2">
        ...
        {(
          [
            { v: true, label: "Yes", cls: "border-emerald-300/60 bg-emerald-300/15 text-emerald-100" },
